...
## Project Structure
    ...
    ├── testapiautocatalog_108771  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_108771`
...
2. Clone this repo and `cd testapiautocatalog_108771`
